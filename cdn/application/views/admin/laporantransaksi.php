...
<script type="text/javascript">
	...
	function loadRiwayat(){
		...
		$.post("<?=site_url("master/laporantransaksi?load=hal")?>",{"gudang":$("#gudang").val(),"status":$("#status").val(),"jenis":$("#jenis").val(),"tglmulai":$("#tglmulai").val(),"tglselesai":$("#tglselesai").val(),[$("#names").val()]:$("#tokens").val()},function(msg){
			var data = eval("("+msg+")");
			updateToken(data.token);
