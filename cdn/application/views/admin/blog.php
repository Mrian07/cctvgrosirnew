	...
	<div class="card">
		<div class="card-header align-items-center">
			<div class="card-title">
				<a class="float-right btn btn-primary" href="<?=site_url("master/editblog")?>"><i class="fas fa-plus-circle"></i> Postingan Baru</a>
...
<script type="text/javascript">
	...
	function loadBlog(page){
		...
		$.post("<?=site_url("master/blog?load=hal&page=")?>"+page,{"cari":$("#cari").val(),[$("#names").val()]:$("#tokens").val()},function(msg){
			var data = eval("("+msg+")");
			updateToken(data.token);
