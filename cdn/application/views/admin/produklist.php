<?php
			...
			foreach($db->result() as $r){
				...
				$button = "
					<a href='".site_url('master/produkform/?copy='.$r->id)."' title='copy' class='btn btn-warning'><i class='fas fa-copy'></i></a>
					<a href='".site_url('master/produkform/'.$r->id)."' title='edit' class='btn btn-primary'><i class='fas fa-pencil-alt'></i></a>
